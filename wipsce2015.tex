...
\begin{abstract}
Human-Computer Interaction is established as a sub-discipline of computer science. There is, however, a gap in its teaching through computational thinking, we present the first step to methodologies for systematically introducing HCI to pupils from an early age, in the same computational thinking style to other sub-disciplines of computer science that have already been considered for the past decade. 
\end{abstract}
